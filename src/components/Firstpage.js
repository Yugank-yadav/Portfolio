      ...
      <section className="about" id="about">
        ...
        <div className="about-content">
          ...
          <p>
            ...
            computer science engineering.<br /> In 2022, I completed my diploma in
            ...
            React js, Node js, MySQL, and REST API.<br /> Over the years, I have
            ...
            skills further.<br /> As a full-stack developer, I am capable of working
            ...
            that provide a seamless user experience.<br /> In my free time, I like to
            ...
            skills and staying up-to-date with the latest technologies.<br /> If you
